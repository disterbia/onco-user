                ...
                <%@ include file="inc/head.jsp" %>
                            ...
                            <div class="form_wrap">
                                ...
                                <div class="tab_nav_wrap none_scroll_bar mb_50 pb_30">
                                    <div class="tab_nav">
                                        ...
                                        <div class="tab_link">
                                            <a href="/main/inquery" class="btn_tab btn on">1:1 문의</a>
                                        </div>
                                        <div class="tab_link">
                                    ...
                                    <div class="px-sm-3 px-0 py_40 text_box mb_50">
                                        ...
                                        <div class="form-row mt_36">
                                            ...
                                            <div class="ip_wr col-md-6">
                                                ...
                                                <input type="text" class="form-control" readonly value="${member.mtHp}"
                                                    id="mtHp">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mt_36">
                                            ...
                                            <div class="row w-100 mail_form">
                                                <div class="d-flex align-items-center mail_wrap col-md-8 col-12">
                                                    ...
                                                    <input type="text" class="form-control" value="${emailParts[0]}"
                                                        id="mtEmail1">
                                                    <p class="px-3 mt-3">@</p>
                                                    <input type="text" class="form-control" value="${emailParts[1]}"
                                                        id="mtEmail2">
                                                </div>
                    ...
                    <script>
                        ...
                        async function insert_inquery() {
                            ...
                            let res = await awaitPostMultipart("./inqueryUpdate.do", params, true);

                            if (res.result == 'success') {
                                console.log(res);
                                open_modal_replace(`./inqueryList`, "문의가 등록되었습니다.");
                            } else {
                                if (res.error_code) {
