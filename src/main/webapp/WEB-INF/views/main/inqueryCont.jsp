...
<div class="sub_pg">
    ...
    <div class="container sub_container2 mb_50">
        ...
        <div class="pt-sm-0 pt-3">
            <button type="button" class="btn btn-primary btn-md d-flex justify-content-between align-items-center mx-auto mt-0" onclick="location.href='/main/inqueryList'">목록으로 <img src="${CDN_HTTP}/images/ico_btn_arrow.png" alt="목록으로"></button>
        </div>
    </div>
</div>
