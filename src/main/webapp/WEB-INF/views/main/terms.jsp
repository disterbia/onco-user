        ...
        <div class="container">
            <div class="breadcrumbs">
                <ul class="d-flex pt_40">
                    ...
                    <li class="mr_14"><a href="javascript:avoid(0)" class="fs_14 fw_400 text-light2 cursor_text">이용약관</a></li>
                </ul>
            </div>
            <p class="tit_h1 mt_50">이용약관</p>
            <p class="sub_top_tit info_line fs_18 line_h1_3 fw_600 mt-3">온코마스터 이용약관입니다.</p>
        </div>
    </div>
