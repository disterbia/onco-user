    ...
    <div class="container sub_container2 notice_wrap mb_50">
        ...
        <div class="tab_nav_wrap none_scroll_bar">
            <div class="tab_nav">
                ...
                <div class="tab_link">
                    <a href="/main/inqueryList" class="btn_tab btn on">나의 문의내역</a>
                </div>
            </div>
        </div>
                        ...
                        <c:otherwise>
                            ...
                            <c:forEach items="${inquerys}" var="inquery">
                                <tr>
                                    ...
                                    <td class="tg-wman text-left fs_16 fw_600 pl_20 line_h1_5"><a href="/main/inqueryCont/${inquery.idx}">${inquery.qtTitle }</a></td>
